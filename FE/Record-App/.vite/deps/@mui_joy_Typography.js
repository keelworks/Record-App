...
var TypographyRoot = styled_default("span", {
  ...
  var _a, _b, _c, _d;
  const lineHeight = ownerState.level !== "inherit" ? (_a = theme.typography[ownerState.level]) == null ? void 0 : _a.lineHeight : "1";
  return _extends({
    ...
    fontSize: `var(--Typography-fontSize, ${ownerState.level && ownerState.level !== "inherit" ? ((_b = theme.typography[ownerState.level]) == null ? void 0 : _b.fontSize) ?? "inherit" : "inherit"})`
  }, ownerState.noWrap && {
    overflow: "hidden",
    ...
    color: `var(--variant-plainColor, rgba(${(_c = theme.vars.palette[ownerState.color]) == null ? void 0 : _c.mainChannel} / 1))`
    ...
    marginInline: "-0.25em"
  }, (_d = theme.variants[ownerState.variant]) == null ? void 0 : _d[ownerState.color]));
});
