              ...
              <div className='grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 gap-2 h-full'>
                <div className='grid md:grid-rows-2 lg:grid-rows-2 gap-2 ml-0 md:ml-6'>
                  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid:cols-2 gap-2 '>
                    <div className='border rounded-2xl  bg-[#0D5299] text-center text-white m-3 p-4 border-black'>
                    ...
                    <div className='border rounded-2xl  bg-[#3D965C] text-center text-white m-4 p-4 border-black ' >
                  ...
                  <div>
                    <div className=' border rounded-2xl flex flex-col  border-black ml-2 mr-2 sm:mr-2'>
                      <div className='flex flex-row bg-[#FCDB76] rounded-t-2xl  w-full '>
                        ...
                        <a  href="" className='w-1/2 flex justify-center p-4 text-[#134C88] underline tracking-wider text-[16px]'>Open Calender</a>
                      </div>
                ...
                <div className='ml-2 mt-6 md:ml-8 sm:mr-2 mr-2'>
                  <div className='border rounded-2xl flex flex-col  border-black   h-full md:mt-0 w-full lg:w-4/5 '>
