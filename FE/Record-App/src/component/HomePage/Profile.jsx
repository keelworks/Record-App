    ...
    <div className='flex min-h-screen '>
      ...
      <div className='w-4/5 relative'>
        ...
        <div className='mt-52 sm:mt-48 md:mt-40 h-auto w-full '>
            <div className='p-2 h-auto text-[16px] text-black w-full '>
              <p className='ml-8'>Record App / Participants Profile</p>
            </div>
            <div className='flex flex-col md:flex-row lg:flex-row items-center justify-between w-full  mb-12 h-auto '>
              <div className='w-full md:w-3/5 lg:w-3/5 mt-4 md:mt-4 lg:mt-0 ml-8 sm:mt-4'>
                <span className='font-semibold text-3xl sm:text-3xl lg:text-[40px] text-black' ><FontAwesomeIcon icon={faLessThan} className='text-black w-[24px] h-[24px] mr-4 mb-1' />
                  Gaurav Patil</span>
              </div>
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-4 '>
                ...
                <div className='text-[20px] text-black'>
                    <div className='grid grid-cols-2 gap-2 my-2 items-center '>
                      ...
                      <div>
                      <Progress.Line percent={100} vertical={false} status='success' /> </div>
                    </div>
                    <div className='grid grid-cols-2 gap-2 my-2 items-center '>
                      <div style={{ marginLeft: '20px' }}>Language Proficiency</div>
                      <div>
                      <Progress.Line percent={40} vertical={false} status='success' />
                       </div>
                    </div>
                    ...
                    <div className='grid sm:grid-cols-2 grid-cols-1 gap-2 my-2 items-center '>
                      ...
                      <div>
                      <Progress.Line percent={60} vertical={false} status='success' />
                       </div>
                    </div>
                    <div className='grid grid-cols-2 gap-2 my-2 items-center '>
                      <div style={{ marginLeft: '20px' }}>Limited Professional Network</div>
                      <div>
                      <Progress.Line percent={80} vertical={false} status='success' />
                       </div>
                    </div>
                    <div className='grid grid-cols-2 gap-2 my-2 items-center '>
                      <div style={{ marginLeft: '20px' }}>Recognition of  Qualifications</div>
                      <div>
                      <Progress.Line percent={30} vertical={false} status='success' />
                       </div>
                    </div>
                    <div className='grid grid-cols-2 gap-2 my-2 items-center '>
                    ...
                    <div className='grid grid-cols-2 gap-2 my-2 items-center '>
                      ...
                      <div>
                      <Progress.Line percent={70} vertical={false} status='success' />
                       </div>
                    </div>
