  ...
  return (
    <div className='flex min-h-screen '>
      ...
      <div className='w-full md:w-4/5 relative'>
        ...
        <div className='mt-56 sm:mt-56 md:mt-40 h-auto w-full '>
          <div className='h-auto text-[16px] text-black w-full mx-10 md:mx-0 '>
            <p className=' ml-4 md:ml-8 py-4 '>Record App / Participants Profile</p>
          </div>
