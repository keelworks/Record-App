  ...
  return (
    ...
    <div className='flex md:flex-col lg:flex-row flex-col   bg-white fixed w-4/5 lg:mt-8  mx-[4rem]  '>
      <div className='w-3/4 ml-2 sm:ml-4 lg:w-7/12 xl:w-4/6 '>
        <div className='w-3/4 border rounded-md border-gray-200 m-4 p-3 flex'>
          ...
          <div className='flex-grow ml-2'>
            <input
              ...
              className='w-full border-none focus:outline-none text-[20px]'
            />
          </div>
        </div>
      </div>
      <div className='w-3/4 flex md:mt-1  ml-2 sm:ml-4 lg:w-2/5 xl:w-1/3  '>
